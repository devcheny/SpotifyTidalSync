...
set "PRUEBAS=test_emparejar test_tidal test_playlists test_convertir test_buscar test_borrar test_actualizar test_completar test_publicar test_normalizar test_publicar_listas"
